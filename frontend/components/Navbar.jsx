    ...
    return (
        <div className="w-full absolute top-0 text-black px-6 py-4 z-10">
            <div className="flex items-center justify-between">
                ...
                {/* Hamburger Menu Icon */}
                {isMobile && isMain && <div className=" cursor-pointer z-50" onClick={toggleMenu}>
                    <motion.div
                        initial={false}
                        animate={isOpen ? "open" : "closed"}
                    >
                        <div className="w-8 h-1 bg-[#F16043] mb-1.5 rounded-full" style={{ transformOrigin: "center" }}></div>
                        <div className="w-8 h-1 bg-[#F16043] mb-1.5 rounded-full" style={{ transformOrigin: "center" }}></div>
                        <div className="w-8 h-1 bg-[#F16043] rounded-full" style={{ transformOrigin: "center" }}></div>
                    </motion.div>
                </div>}

                {/* Desktop Navigation */}
                {!isMobile && isMain && <nav className="flex h-[70px] items-center space-x-8 text-[#F16043] text-xl">
